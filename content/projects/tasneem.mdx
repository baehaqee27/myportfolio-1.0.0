---
title: "Tasneem - Aplikasi Al-Quran Digital"
date: "2025-12-17"
description: "Aplikasi Al-Quran digital modern dengan antarmuka clean, audio murottal, dan fitur ibadah harian."
thumbnail: "/public/og-image.png"
stack: ["Next.js 15", "TypeScript", "Tailwind CSS", "Shadcn UI", "Framer Motion"]
demo: "https://tasneem.mattrizz.web.id"
published: true
---
...
1.  **Clone repository ini**
    ...
    ```bash
    git clone https://github.com/baehaqee27/tasneem.git
    cd tasneem
    ```
