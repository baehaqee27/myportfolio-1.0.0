...
export const BackgroundBeams = () => {
  return (
    <div className="absolute inset-0 overflow-hidden -z-10 w-full pointer-events-none">
      {/* Static Glows */}
      <div className="absolute top-[-20%] left-1/4 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[150px] animate-pulse" />
      <div className="absolute bottom-[-20%] right-1/4 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[150px] animate-pulse delay-1000" />
      ...
      <motion.div
        className="absolute top-[-50%] left-[-50%] w-[200%] h-[200%] bg-gradient-to-b from-transparent via-primary/5 to-transparent rotate-[30deg] blur-3xl"
        animate={{
          x: ["-50%", "0%"],
          y: ["-50%", "0%"],
        }}
